...
public interface IAssemblyAnalyzer
{
    ...
    /// The name of the primary key property used to establish relationships when <paramref name="useCustomLogic"/> is enabled.
    ...
    ///     </item>
    ///     <item>
    ///         <description>A list of <see cref="Relationship"/> objects representing relationships such as inheritance and key-based associations.</description>
    ///     </item>
    /// </list>
    /// </returns>
    ...
    /// <summary>
    /// Analyzes all loaded assemblies in the current application domain and extracts entities and relationships within a specified namespace.
    /// </summary>
